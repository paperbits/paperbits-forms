...
import template from "./passwordInputEditor.html";
...
@Component({
    selector: "password-input-editor",
    template: template
})
export class PasswordInputEditor {
    ...
    @Param()
    public model: PasswordInputModel;

    @Event()
    public onChange: (model: PasswordInputModel) => void;
