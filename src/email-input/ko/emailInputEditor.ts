...
import template from "./emailInputEditor.html";
...
@Component({
    selector: "email-input-editor",
    template: template
})
export class EmailInputEditor {
    ...
    @Param()
    public model: EmailInputModel;

    @Event()
    public onChange: (model: EmailInputModel) => void;
