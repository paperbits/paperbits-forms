...
import template from "./multilineInputEditor.html";
...
@Component({
    selector: "multiline-input-editor",
    template: template
})
export class MultilineInputEditor {
    ...
    @Param()
    public model: MultilineInputModel;

    @Event()
    public onChange: (model: MultilineInputModel) => void;
